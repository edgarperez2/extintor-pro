      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: "10px", color: "#aaa", textTransform: "uppercase", letterSpacing: "0.06em", marginTop: "1px" }}>Portal cliente</div>
          </div>
        </div>
        ...
        <div style={{ padding: "10px 8px", borderTop: "1px solid #EBEBEB" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "9px", padding: "8px 11px", marginBottom: "4px" }}>
            <div style={{
              width: "30px", height: "30px", background: "#E24B4A",
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{ fontSize: "11px", color: "#aaa", marginTop: "1px" }}>Cliente</div>
            </div>
          </div>
          <button
